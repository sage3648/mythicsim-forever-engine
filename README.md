...
- **Tank Warrior uses a Protection rotation.** Its default priority starts in Defensive Stance and uses Shield Slam, Revenge, Thunder Clap, and Sunder Armor when applicable with a weapon and shield. The modeled ability values and raid conditions still need beta validation. Feral Druid is still the one spec on a partial set, at 8 of 17 slots.
