...
const valueKindFactories: { [f in NonNullable<APLValueKind>]: ValueKindConfig<APLValueImplTypesUnion[f]> } = {
	...
	maxRage: inputBuilder({
		label: 'Max Rage',
		submenu: ['Resources'],
		shortDescription: 'Maximum amount of Rage.',
	...
	maxEnergy: inputBuilder({
		label: 'Max Energy',
		submenu: ['Resources'],
		shortDescription: 'Maximum amount of Energy.',
	...
	maxComboPoints: inputBuilder({
		...
		submenu: ['Resources'],
		shortDescription: 'Maximum amount of Combo Points.',
	...
	spellFullCooldown: inputBuilder({
		label: 'Full Cooldown',
		submenu: ['Spell'],
		shortDescription: 'The full cooldown of this spell, or <b>0</b> if it has no cooldown.',
	...
	auraIsInactive: inputBuilder({
		label: 'Aura Inactive',
		submenu: ['Aura'],
		shortDescription: '<b>True</b> if the aura is not currently active, otherwise <b>False</b>.',
		newValue: APLValueAuraIsInactive.create,
		fields: [AplHelpers.unitFieldConfig('sourceUnit', 'aura_sources'), AplHelpers.actionIdFieldConfig('auraId', 'auras', 'sourceUnit')],
	}),
	...
	auraDuration: inputBuilder({
		label: 'Aura Duration',
		submenu: ['Aura'],
		shortDescription: 'The full duration of the aura.',
	...
	dotTimeToNextTick: inputBuilder({
		...
		submenu: ['DoT'],
		shortDescription: 'Time until the next tick of this DoT, or 0 if the DoT is not currently ticking.',
	...
	variableRef: inputBuilder({
		label: 'Variable',
		submenu: ['Variables'],
		shortDescription: 'The value of a named variable.',
		fullDescription: `
			<p>Looks up the variable first in the <b>Action Group</b> being run (if any), then in the rotation's <b>Variables</b> list.</p>
		`,
		newValue: APLValueVariableRef.create,
		fields: [AplHelpers.stringFieldConfig('name')],
	}),
	variablePlaceholder: inputBuilder({
		label: 'Variable Placeholder',
		submenu: ['Variables'],
		shortDescription: 'Inside an <b>Action Group</b>: a value that each <b>Group Reference</b> must fill in by name.',
		newValue: APLValueVariablePlaceholder.create,
		fields: [AplHelpers.stringFieldConfig('name')],
	}),
	actionGroupUsed: inputBuilder({
		label: 'Action Group Is Used',
		submenu: ['Variables'],
		shortDescription: '<b>True</b> if the named <b>Action Group</b> is referenced by an enabled action, otherwise <b>False</b>.',
